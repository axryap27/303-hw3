...
# Generated on: Mon May 25 11:24:14 CDT 2026 (Mon May 25 16:24:14 GMT 2026)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/transition_detector/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/transition_detector -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../transition_detector.v
elaborate_design -golden -root {transition_detector} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/transition_detector/fv_map.v.gz
elaborate_design -revised -root {transition_detector}
...
#add_name_alias fv/transition_detector/fv_map.singlebit.original_name.alias.json.gz -revised
