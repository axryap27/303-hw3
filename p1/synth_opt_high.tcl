# synth_opt_high.tcl
# ECE 303 HW 3 Problem 1 - Genus synthesis at HIGH effort
...
read_hdl [list transition_detector.v]
...
elaborate transition_detector
current_design transition_detector

read_sdc ../transition_detector.sdc
...
write_hdl > synth_opt_high/transition_detector_syn_high.v
write_sdc > synth_opt_high/transition_detector_syn_high.sdc
