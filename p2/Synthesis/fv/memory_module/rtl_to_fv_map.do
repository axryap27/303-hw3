...
# Generated on: Mon May 25 14:37:09 CDT 2026 (Mon May 25 19:37:09 GMT 2026)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/memory_module/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/memory_module -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../memory_module.v
elaborate_design -golden -root {memory_module} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/memory_module/fv_map.v.gz
elaborate_design -revised -root {memory_module}
...
#add_name_alias fv/memory_module/fv_map.singlebit.original_name.alias.json.gz -revised
